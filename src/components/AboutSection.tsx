...
import { Divider, Typography, Grid, Avatar, Box } from "@mui/material";
...
export default function AboutSection() {
    return (
        <>
            <Divider />
            <Typography style={{ fontSize: '20px', fontWeight: 'bold' }} padding={2}>Về chúng tôi</Typography>
            <Grid container spacing={4}>
                <Grid item xs={12}>
                    ...
                    >
                        ...
                        <Typography sx={{ padding: '0 300px', marginBottom: '30px', textAlign: 'center' }}>Trong suốt 5 năm học dưới mái trường đại học, em đã nhận được sự yêu thương, dạy dỗ của rất nhiều thầy cô giáo, trong đó người để lại trong trái tim em nhiều tình cảm tốt đẹp nhất chính là cô Mai Phương- giáo viên chủ nhiệm lớp em.</Typography>
                    </Box>
                </Grid>
